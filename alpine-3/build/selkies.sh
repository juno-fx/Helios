...
apk add --no-cache $(cat /lists/selkies-alpine.list)
cat /lists/selkies-alpine.list
pip --version
...
apk del $(cat /lists/selkies-alpine.list)

# clean up
rm -rfv /var/lib/{cache,log}/ /etc/systemd /var/tmp/* /tmp/*
